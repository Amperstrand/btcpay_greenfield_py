...
from ...models.webhook_data_create import WebhookDataCreate
from ...models.webhook_data_create_result import WebhookDataCreateResult
...
) -> WebhookDataCreateResult | list[ValidationProblemDetailsItem] | None:
    if response.status_code == 200:
        response_200 = _safe_from_dict(WebhookDataCreateResult.from_dict, response)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[WebhookDataCreateResult | list[ValidationProblemDetailsItem]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        WebhookDataCreateResult | list[ValidationProblemDetailsItem]
    """
