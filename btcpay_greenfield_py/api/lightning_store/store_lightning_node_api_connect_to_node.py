...
from ...models.connect_to_node_request import ConnectToNodeRequest
...
def _get_kwargs(
    ...
    crypto_code: str,
    *,
    body: ConnectToNodeRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/stores/{store_id}/lightning/{crypto_code}/connect".format(
