...
from ...models.update_lightning_network_payment_method_request import UpdateLightningNetworkPaymentMethodRequest
...
def _get_kwargs(
    ...
    crypto_code: str,
    *,
    body: UpdateLightningNetworkPaymentMethodRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/stores/{store_id}/payment-methods/LightningNetwork/{crypto_code}".format(
...
) -> Any | LightningNetworkPaymentMethodData | list[ValidationProblemDetailsItem] | None:
    if response.status_code == 200:
        response_200 = _safe_from_dict(LightningNetworkPaymentMethodData.from_dict, response)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | LightningNetworkPaymentMethodData | list[ValidationProblemDetailsItem]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | LightningNetworkPaymentMethodData | list[ValidationProblemDetailsItem]
    """
