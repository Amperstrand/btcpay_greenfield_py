...
from ...models.mark_invoice_status_request import MarkInvoiceStatusRequest
...
def _get_kwargs(
    ...
    invoice_id: str,
    *,
    body: MarkInvoiceStatusRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/stores/{store_id}/invoices/{invoice_id}/status".format(
...
) -> Any | InvoiceData | list[ValidationProblemDetailsItem] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | InvoiceData | list[ValidationProblemDetailsItem]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | InvoiceData | list[ValidationProblemDetailsItem]
    """
