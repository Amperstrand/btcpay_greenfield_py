...
from ...models.payment_request_base_data import PaymentRequestBaseData
...
) -> Any | PaymentRequestData | list[ValidationProblemDetailsItem] | None:
    if response.status_code == 200:
        response_200 = _safe_from_dict(PaymentRequestData.from_dict, response)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | PaymentRequestData | list[ValidationProblemDetailsItem]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | PaymentRequestData | list[ValidationProblemDetailsItem]
    """
