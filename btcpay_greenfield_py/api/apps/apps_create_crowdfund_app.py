...
from ...models.create_crowdfund_app_request import CreateCrowdfundAppRequest
from ...models.crowdfund_app_data import CrowdfundAppData
...
def _get_kwargs(
    store_id: str,
    *,
    body: CreateCrowdfundAppRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/stores/{store_id}/apps/crowdfund".format(
...
) -> CrowdfundAppData | list[ValidationProblemDetailsItem] | None:
    if response.status_code == 200:
        response_200 = _safe_from_dict(CrowdfundAppData.from_dict, response)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CrowdfundAppData | list[ValidationProblemDetailsItem]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        CrowdfundAppData | list[ValidationProblemDetailsItem]
    """
