...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/server/lightning/{crypto_code}/invoices/pay".format(
...
def sync_detailed(
    ...
    *,
    ...
    payment](#operation/InternalLightningNodeApi_GetPayment) endpoint. The default wait time for payment
