...
from ...models.email_settings_data import EmailSettingsData
...
def _get_kwargs(
    store_id: str,
    *,
    body: EmailSettingsData,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/stores/{store_id}/email".format(
...
) -> Any | EmailSettingsData | list[ValidationProblemDetailsItem] | None:
    if response.status_code == 200:
        response_200 = _safe_from_dict(EmailSettingsData.from_dict, response)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | EmailSettingsData | list[ValidationProblemDetailsItem]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | EmailSettingsData | list[ValidationProblemDetailsItem]
    """
