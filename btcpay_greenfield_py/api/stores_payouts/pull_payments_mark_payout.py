...
from ...models.pull_payments_mark_payout_body import PullPaymentsMarkPayoutBody
...
def _get_kwargs(
    ...
    payout_id: str,
    *,
    body: PullPaymentsMarkPayoutBody | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/stores/{store_id}/payouts/{payout_id}/mark".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        store_id (str):
        payout_id (str):
        body (PullPaymentsMarkPayoutBody | Unset):
