...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/users/me/notifications/{id}".format(
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Any | NotificationData | None:
