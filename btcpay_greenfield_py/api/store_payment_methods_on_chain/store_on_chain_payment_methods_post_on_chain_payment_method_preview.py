...
from ...models.store_on_chain_payment_methods_post_on_chain_payment_method_preview_body import (
...
def _get_kwargs(
    ...
    crypto_code: str,
    *,
    body: StoreOnChainPaymentMethodsPOSTOnChainPaymentMethodPreviewBody,
