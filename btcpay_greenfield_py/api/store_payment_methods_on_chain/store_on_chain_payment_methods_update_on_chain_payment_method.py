...
from ...models.update_on_chain_payment_method_request import UpdateOnChainPaymentMethodRequest
...
def _get_kwargs(
    ...
    crypto_code: str,
    *,
    body: UpdateOnChainPaymentMethodRequest,
) -> dict[str, Any]:
...
) -> Any | OnChainPaymentMethodData | list[ValidationProblemDetailsItem] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | OnChainPaymentMethodData | list[ValidationProblemDetailsItem]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | OnChainPaymentMethodData | list[ValidationProblemDetailsItem]
    """
