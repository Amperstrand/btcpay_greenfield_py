...
class TestOnChainWalletObjectData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OnChainWalletObjectData:
        """Test OnChainWalletObjectData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnChainWalletObjectData`
        """
        model = OnChainWalletObjectData()
        if include_optional:
    ...
    def testOnChainWalletObjectData(self):
        """Test OnChainWalletObjectData"""
