...
class TestStoreRateResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StoreRateResult:
        """Test StoreRateResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StoreRateResult`
        """
        model = StoreRateResult()
        if include_optional:
