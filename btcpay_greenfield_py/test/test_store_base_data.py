...
class TestStoreBaseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StoreBaseData:
        """Test StoreBaseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StoreBaseData`
        """
        model = StoreBaseData()
        if include_optional:
            return StoreBaseData(
                name = '',
                website = '',
                support_url = '',
