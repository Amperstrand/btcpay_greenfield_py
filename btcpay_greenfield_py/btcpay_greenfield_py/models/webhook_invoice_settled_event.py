...
class WebhookInvoiceSettledEvent(BaseModel):
    """
    ...
    manually_marked: Optional[StrictBool] = Field(default=None, description="Whether the invoice have been manually marked as confirmed", alias="manuallyMarked")
    ...
    __properties: ClassVar[List[str]] = ["deliveryId", "webhookId", "originalDeliveryId", "isRedelivery", "type", "timestamp", "storeId", "invoiceId", "metadata", "manuallyMarked", "overPaid"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "manuallyMarked": obj.get("manuallyMarked"),
