...
class WebhookInvoiceInvalidEvent(BaseModel):
    """
    ...
    manually_marked: Optional[StrictBool] = Field(default=None, description="Whether the invoice have been manually marked as confirmed. If false, this invoice has received payments which could not confirm in time.", alias="manuallyMarked")
    __properties: ClassVar[List[str]] = ["deliveryId", "webhookId", "originalDeliveryId", "isRedelivery", "type", "timestamp", "storeId", "invoiceId", "metadata", "manuallyMarked"]
