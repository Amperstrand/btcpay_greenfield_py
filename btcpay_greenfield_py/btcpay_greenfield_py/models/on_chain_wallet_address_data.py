...
class OnChainWalletAddressData(BaseModel):
    """
    OnChainWalletAddressData
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="The bitcoin address")
    ...
    payment_link: Optional[StrictStr] = Field(default=None, description="a bip21 payment link", alias="paymentLink")
    __properties: ClassVar[List[str]] = ["address", "keyPath", "paymentLink"]
