...
class QuoteResultData(BaseModel):
    """
    QuoteResultData
    """ # noqa: E501
    ...
    bid: Optional[StrictStr] = Field(default=None, description="The bid price.")
    ask: Optional[StrictStr] = Field(default=None, description="The ask price")
    __properties: ClassVar[List[str]] = ["fromAsset", "toAsset", "bid", "ask"]
