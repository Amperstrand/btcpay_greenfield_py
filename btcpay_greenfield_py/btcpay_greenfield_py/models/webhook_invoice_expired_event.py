...
class WebhookInvoiceExpiredEvent(BaseModel):
    """
    ...
    partially_paid: Optional[StrictBool] = Field(default=None, description="Whether the invoice received some payments before being expired.", alias="partiallyPaid")
    __properties: ClassVar[List[str]] = ["deliveryId", "webhookId", "originalDeliveryId", "isRedelivery", "type", "timestamp", "storeId", "invoiceId", "metadata", "partiallyPaid"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "partiallyPaid": obj.get("partiallyPaid")
        })
        return _obj
