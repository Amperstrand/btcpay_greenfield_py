...
class PatchOnChainTransactionRequest(BaseModel):
    """
    PatchOnChainTransactionRequest
    """ # noqa: E501
    comment: Optional[StrictStr] = Field(default=None, description="Transaction comment")
    labels: Optional[List[StrictStr]] = Field(default=None, description="Transaction labels")
    __properties: ClassVar[List[str]] = ["comment", "labels"]
