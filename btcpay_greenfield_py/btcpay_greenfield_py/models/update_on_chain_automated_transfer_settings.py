...
class UpdateOnChainAutomatedTransferSettings(BaseModel):
    """
    UpdateOnChainAutomatedTransferSettings
    """ # noqa: E501
    fee_target_block: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="How many blocks should the fee rate calculation target to confirm in. Set to 1 if not provided", alias="feeTargetBlock")
    interval_seconds: Optional[object] = Field(default=None, alias="intervalSeconds")
    threshold: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Only process payouts when this payout sum is reached.")
    ...
    __properties: ClassVar[List[str]] = ["feeTargetBlock", "intervalSeconds", "threshold", "processNewPayoutsInstantly"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if fee_target_block (nullable) is None
        # and model_fields_set contains the field
        if self.fee_target_block is None and "fee_target_block" in self.model_fields_set:
            _dict['feeTargetBlock'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "feeTargetBlock": obj.get("feeTargetBlock"),
