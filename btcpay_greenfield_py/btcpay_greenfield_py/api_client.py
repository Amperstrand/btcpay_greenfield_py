...
import btcpay_greenfield_py.models
from btcpay_greenfield_py import rest
from btcpay_greenfield_py.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(btcpay_greenfield_py.models, klass)
