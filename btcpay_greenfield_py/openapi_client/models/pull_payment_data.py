...
class PullPaymentData(BaseModel):
    ...
    bolt11_expiration: Optional[StrictStr] = Field(default=None, description="If lightning is activated, do not accept BOLT11 invoices with expiration less than … days", alias="BOLT11Expiration")
