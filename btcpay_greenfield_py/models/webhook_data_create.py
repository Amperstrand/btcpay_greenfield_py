...
T = TypeVar("T", bound="WebhookDataCreate")


@_attrs_define
class WebhookDataCreate:
    """
    Attributes:
        ...
        secret (None | str | Unset): Must be used by the callback receiver to ensure the delivery comes from BTCPay
            ...
            Github](https://docs.github.com/webhooks/securing/). If left out, null, or empty, the secret will be auto-
            generated.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        webhook_data_create.additional_properties = d
        return webhook_data_create
