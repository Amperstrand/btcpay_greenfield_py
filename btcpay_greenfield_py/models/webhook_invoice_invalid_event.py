...
T = TypeVar("T", bound="WebhookInvoiceInvalidEvent")


@_attrs_define
class WebhookInvoiceInvalidEvent:
    ...
    Attributes:
        ...
        metadata (WebhookInvoiceEventMetadata | Unset): User-supplied metadata added to the invoice at the time of its
            creation
        manually_marked (bool | Unset): Whether the invoice have been manually marked as confirmed. If false, this
    ...
    manually_marked: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if manually_marked is not UNSET:
            field_dict["manuallyMarked"] = manually_marked
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        manually_marked = d.pop("manuallyMarked", UNSET)

        webhook_invoice_invalid_event = cls(
        ...
        webhook_invoice_invalid_event.additional_properties = d
        return webhook_invoice_invalid_event
