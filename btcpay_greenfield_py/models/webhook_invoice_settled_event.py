...
T = TypeVar("T", bound="WebhookInvoiceSettledEvent")


@_attrs_define
class WebhookInvoiceSettledEvent:
    ...
    Attributes:
        ...
        metadata (WebhookInvoiceEventMetadata | Unset): User-supplied metadata added to the invoice at the time of its
            creation
        manually_marked (bool | Unset): Whether the invoice have been manually marked as confirmed
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        webhook_invoice_settled_event = cls(
        ...
        webhook_invoice_settled_event.additional_properties = d
        return webhook_invoice_settled_event
