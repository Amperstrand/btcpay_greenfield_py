...
T = TypeVar("T", bound="WebhookInvoiceEvent")


@_attrs_define
class WebhookInvoiceEvent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        webhook_invoice_event.additional_properties = d
        return webhook_invoice_event
