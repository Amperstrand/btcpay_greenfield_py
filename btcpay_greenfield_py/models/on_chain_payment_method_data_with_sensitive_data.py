...
T = TypeVar("T", bound="OnChainPaymentMethodDataWithSensitiveData")


@_attrs_define
class OnChainPaymentMethodDataWithSensitiveData:
    """
    Attributes:
        ...
        mnemonic (str | Unset): The mnemonic used to generate the wallet
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        on_chain_payment_method_data_with_sensitive_data = cls(
        ...
        on_chain_payment_method_data_with_sensitive_data.additional_properties = d
        return on_chain_payment_method_data_with_sensitive_data
