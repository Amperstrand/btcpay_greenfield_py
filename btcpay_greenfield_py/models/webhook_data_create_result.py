...
T = TypeVar("T", bound="WebhookDataCreateResult")


@_attrs_define
class WebhookDataCreateResult:
    """
    Attributes:
        ...
        secret (None | str | Unset): Must be used by the callback receiver to ensure the delivery comes from BTCPay
            ...
            Github](https://docs.github.com/webhooks/securing/). Value of the auto-generated or custom secret.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        webhook_data_create_result = cls(
            enabled=enabled,
        ...
        webhook_data_create_result.additional_properties = d
        return webhook_data_create_result
