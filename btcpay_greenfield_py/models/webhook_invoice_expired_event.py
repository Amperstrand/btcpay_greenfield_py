...
T = TypeVar("T", bound="WebhookInvoiceExpiredEvent")


@_attrs_define
class WebhookInvoiceExpiredEvent:
    ...
    Attributes:
        ...
        metadata (WebhookInvoiceEventMetadata | Unset): User-supplied metadata added to the invoice at the time of its
            creation
        partially_paid (bool | Unset): Whether the invoice received some payments before being expired.
    """
    ...
    partially_paid: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if partially_paid is not UNSET:
            field_dict["partiallyPaid"] = partially_paid
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        partially_paid = d.pop("partiallyPaid", UNSET)

        webhook_invoice_expired_event = cls(
        ...
        webhook_invoice_expired_event.additional_properties = d
        return webhook_invoice_expired_event
