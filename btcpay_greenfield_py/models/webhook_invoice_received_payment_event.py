...
T = TypeVar("T", bound="WebhookInvoiceReceivedPaymentEvent")


@_attrs_define
class WebhookInvoiceReceivedPaymentEvent:
    ...
    Attributes:
        ...
        metadata (WebhookInvoiceEventMetadata | Unset): User-supplied metadata added to the invoice at the time of its
            creation
        after_expiration (bool | Unset): Whether this payment has been sent after expiration of the invoice
    ...
    after_expiration: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if after_expiration is not UNSET:
            field_dict["afterExpiration"] = after_expiration
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        after_expiration = d.pop("afterExpiration", UNSET)
        ...
        webhook_invoice_received_payment_event = cls(
        ...
        webhook_invoice_received_payment_event.additional_properties = d
        return webhook_invoice_received_payment_event
